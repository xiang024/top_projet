...
/// The obstacle is a circle of center (`OBSTACLE_X`, `OBSTACLE_Y`) and of radius `OBSTACLE_R`.
///
...
/// @brief Initializes the entire fluid with a Poiseuille distribution corresponding to a linear flow at equilibrium.
/// @param mesh The mesh to initialize.
/// @param mesh_type The information grid denotating the type of mesh.
